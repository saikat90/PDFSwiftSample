 ...
 */
+ (NSDictionary *)styleDefaultForAnnotationType:(PTExtendedAnnotType)annotType;
 ...
 */
+ (NSDictionary *)styleDefaultForAnnotationType:(PTExtendedAnnotType)annotType presetIndex:(int)index;
