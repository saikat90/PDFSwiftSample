...
/**
 * Whether the undo-redo manager is enabled and updates the undo/redo state. When disabled (value is
 * set to `NO`), the `NSUndoManager` owned by the `pdfViewCtrl` is cleared of all its actions.
 *
