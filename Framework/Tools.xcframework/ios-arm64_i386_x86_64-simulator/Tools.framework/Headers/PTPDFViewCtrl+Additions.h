 ...
 */
- (BOOL)DocLock:(BOOL)cancelThreads withBlock:(void (NS_NOESCAPE ^)(PTPDFDoc * _Nullable doc))block error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * indicate that it throws an error in cases of failure.
 */
- (BOOL)DocLockReadWithBlock:(void (NS_NOESCAPE ^)(PTPDFDoc * _Nullable doc))block error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * indicate that it throws an error in cases of failure.
 */
- (BOOL)NavigateToPageNumber:(int)pageNumber error:(NSError * _Nullable __autoreleasing * _Nullable)error;
