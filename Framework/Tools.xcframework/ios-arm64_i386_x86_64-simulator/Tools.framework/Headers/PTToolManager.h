 ...
 * a more advanced version that the current behaviour.
 *
...
/**
 * A boolean value that determines if annotation in reflow mode is enabled.
 *
 * Default value is true.
*/
@property (nonatomic, assign, getter=isAnnotationOnReflowEnabled) BOOL annotateOnReflowEnabled;
