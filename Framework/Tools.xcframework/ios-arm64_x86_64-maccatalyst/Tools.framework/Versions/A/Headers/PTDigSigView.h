 ...
 */
- (instancetype)initWithFrame:(CGRect)frame withColour:(UIColor *)color withStrokeThickness:(CGFloat)thickness withTypes:(NSArray<NSNumber *> *)signatureTypes NS_DESIGNATED_INITIALIZER;
