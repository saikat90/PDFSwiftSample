...
/**
 * Shows the `PTReflowSettingsViewController`.
 */
@property (nonatomic, readonly, strong) UIBarButtonItem *reflowSettingButtonItem;
 ...
 * The default value of this property is `YES`.
 */
@property (nonatomic, getter=isReflowSettingButtonHidden) BOOL reflowSettingButtonHidden;
